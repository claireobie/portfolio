<template>
  <div>
      ...
      @sliding-end="onSlideEnd">
          <b-carousel-slide img-src="https://i.imgur.com/JhPx156.jpg" alt="The University of Montana Mobile app website" style="height:450px; width:800px">
              <p class="image-text">
                  I aided in designing the
                  <a href="https://www.umt.edu/mobile/" alt="The University of Montana Mobile app website" style="color: white">
          ...
          <b-carousel-slide img-src="https://i.imgur.com/jkN2q43.png" alt="Legend of Zelda" style="height:450px; width:800px">
              <p class="image-text">
                  I was part of a team that built an app named
                  <a href="https://rocky-refuge-16506.herokuapp.com/" alt="A food bank application for tracking inventory and creating meal plans." style="color: white">
          ...
          <b-carousel-slide img-src="https://i.imgur.com/rPwhiir.jpg" alt="The Universiry of Montana Writing Center" style="height:450px; width:800px">
              <p class="image-text">
                  I designed and implemented a website re-design for the
                  <a href="https://www.umt.edu/writingcenter/" alt="The University of Montana Writing Center" style="color: white">
          ...
          <b-carousel-slide img-src="https://i.imgur.com/wh5xYB9.png" alt="Pig latin application" style="height:450px; width:800px">
              <p class="image-text">
                  This project started as a way to practice Javascript but turned into an
                  <a href="https://www.npmjs.com/package/pig-latin-library" alt="Pig Latin library npm package" style="color: white">
                    npm package
                  </a> and
                  <a href="https://pig-latin-library.herokuapp.com/" alt="Pig latin library application" style="color: white">
                    an application
          ...
          <b-carousel-slide img-src="https://i.imgur.com/URtztkl.png" alt="Hangman game" style="height:450px; width:800px">
              <p class="image-text">
                  This is a
                  <a href="https://obscure-inlet-95154.herokuapp.com/" alt="Hangman game" style="color: white">
                  Hangman game
          ...
          <b-carousel-slide img-src="https://i.imgur.com/R1GuFLe.jpg" alt="Legend of Zelda Translator application" style="height:450px; width:800px">
              <p class="image-text">
                  <a href="https://powerful-lake-84714.herokuapp.com/" alt="Legend of Zelda Translator application" style="color: white">
